...
public class EqualizerSurface extends SurfaceView
{
	...
	private final Paint mWhite, mGridLines, mControlBarText, mFrequencyResponseBg;
	...
	public EqualizerSurface(Context context, AttributeSet attributeSet)
	{
		...
		mControlBarText.setShadowLayer(2, 0, 0, getResources().getColor(R.color.white));
...
//상관없는 물건(?)
		...
		mFrequencyResponseHighlight.setColor(getResources().getColor(R.color.white));
		...
		mFrequencyResponseHighlight2.setColor(getResources().getColor(R.color.white));
