...
public class EqualizerSurface extends SurfaceView {
    ...
    private final Paint mWhite, mControlBarText;
    private final Paint mFrequencyResponseBg, mBackground;
    ...
    public EqualizerSurface(Context context, AttributeSet attributeSet) {
        ...
        mBackground.setColor(getResources().getColor(R.color.white));
        ...
        //글자 색깔
        mWhite = new Paint();
        mWhite.setColor(getResources().getColor(R.color.primary));
        mWhite.setStyle(Style.STROKE);
        mWhite.setTextSize(18);
        mWhite.setAntiAlias(true);

        /*격자무늬
        mGridLines = new Paint();
        mGridLines.setColor(getResources().getColor(R.color.black));
        mGridLines.setStyle(Style.STROKE); */

        //주파수, 음량 표시
        mControlBarText = new Paint(mWhite);
        mControlBarText.setTextAlign(Paint.Align.CENTER);
        mControlBarText.setShadowLayer(2, 0, 0, getResources().getColor(R.color.primary)); 
        ...
        mControlBarKnob.setColor(getResources().getColor(R.color.black));
        ...
        mFrequencyResponseHighlight.setColor(getResources().getColor(R.color.primary));
        ...
        mFrequencyResponseHighlight2.setColor(getResources().getColor(R.color.primary));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        /*int[] responseColors = {
                res.getColor(color.transparent)
